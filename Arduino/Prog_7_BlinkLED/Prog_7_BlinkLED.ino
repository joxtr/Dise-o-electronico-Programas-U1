...
void setup() {
  ...
  // es entrada cuando nos proporciona "informacion" (sensor), y es salida cuando genera algun "efecto" (actuador)
...
void loop() {
  ...
  //Cuando se trabaja con actuadores digitales se encuentra con la instruccion digitalWrite para establecer el valor del
  //actuador
